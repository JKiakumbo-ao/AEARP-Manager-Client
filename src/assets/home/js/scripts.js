...
(function ($) {
    ...
    jQuery(document).ready(function () {
       ...
       /* Mobile Navigation Hide or Collapse on Click */
        ...
        $(".typing").typed({
            strings: ["Nós somos estudantes angolanos na República da Polónia.", "O nosso objetivo é:", "Formar-se para desevolver Angola."],    /* You can change the home section typing text from
        ...
        $('.statistics').appear(function() {
         ...
         $('#my-address').gMap({
            ...
            markers:[
            {
            address: "Poland",  /* You can change your address from here */
